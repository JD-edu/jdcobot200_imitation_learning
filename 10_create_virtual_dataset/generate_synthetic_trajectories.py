...
class TrajectoryGenerator:
    def __init__(self, xml: Path, control_hz: int, min_floor_clearance: float) -> None:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--xml", type=Path, default=ROOT / "scene.xml")
...
def main() -> None:
    ...
    generator = TrajectoryGenerator(
        args.xml, args.control_hz, args.min_floor_clearance
    )
    manifest = {
        "format_version": 1,
